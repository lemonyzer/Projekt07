...
Status_2	
	RRF	gSTATUS		;empfangenes Bit in Register hinzufügen
	BSF	a_CLOCK
	CALL	UP_wait_25us
...
L_btns_2	
	RRF	gLEFT		;empfangenes Bit in Register hinzufügen
	BSF	a_CLOCK
	CALL	UP_wait_25us
	DECF	zaehler		;zaehler -1
	MOVF	zaehler,F		;zaehler ins Arbeitsregister...
...
R_btns_2	
	RRF	gRIGHT		;empfangenes Bit in Register hinzufügen
	BSF	a_CLOCK
	CALL	UP_wait_25us
	DECF	zaehler		;zaehler -1
	MOVF	zaehler,F		;zaehler ins Arbeitsregister...
...
R_JoyX_2	
	RRF	gRJoyX		;empfangenes Bit in Register hinzufügen
	BSF	a_CLOCK
	CALL	UP_wait_25us
	DECF	zaehler		;zaehler -1
	MOVF	zaehler,F		;zaehler ins Arbeitsregister...
...
R_JoyY_2	
	RRF	gRJoyY		;empfangenes Bit in Register hinzufügen
	BSF	a_CLOCK
	CALL	UP_wait_25us
	DECF	zaehler		;zaehler -1
	MOVF	zaehler,F		;zaehler ins Arbeitsregister...
...
L_JoyX_2	
	RRF	gLJoyX		;empfangenes Bit in Register hinzufügen
	BSF	a_CLOCK
	CALL	UP_wait_25us
	DECF	zaehler		;zaehler -1
	MOVF	zaehler,F		;zaehler ins Arbeitsregister...
...
L_JoyY_2	
	RRF	gLJoyY		;empfangenes Bit in Register hinzufügen
	BSF	a_CLOCK
	CALL	UP_wait_25us
	DECF	zaehler		;zaehler -1
	MOVF	zaehler,F		;zaehler ins Arbeitsregister...

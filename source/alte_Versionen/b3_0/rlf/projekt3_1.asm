...
UP_MAX_LED_display
	...
	SUBWF	gRJoyX,W		;= workregister
				...
				;if Y <= w:
		   		;Status,Z = Status,C.
		   		;(i.e., either both are 1, or both are 0).
 				
 	BTFSC	STATUS,C		;wenn STATUS,C ..
 	GOTO	x_Achse_1	; = 1
  	BTFSC	STATUS,Z		; = 0 
  	GOTO	x_Achse_GROESSER_85
 	
x_Achse_KLEINER_GLEICH_85  	; gRJoyX <= 85
	MOVLW	D'85'
	SUBWF	gRJoyY,W
	...
	GOTO	y_Achse_1
  	BTFSC	STATUS,Z		 
  	GOTO	y_Achse_GROESSER_85
	  
y_Achse_KLEINER_GLEICH_85
	BSF	m_display_r,0	
	RETURN
	      			;	A  B  C		O  X  X
				;	DP A2 D		X  X  X
...
x_Achse_1
	...
	GOTO	x_Achse_GROESSER_85	; = 0
	GOTO	x_Achse_KLEINER_GLEICH_85	; = 1 ->>> x-Achse <= 85

y_Achse_1
 	BTFSS	STATUS,Z			;wenn STATUS,Z ..
	GOTO	y_Achse_GROESSER_85	; = 0
	GOTO	y_Achse_KLEINER_GLEICH_85	; = 1 ->>> y-Achse <= 85	
...
y_Achse_GROESSER_85
	...
	SUBWF	gRJoyY,W
		        		; if Y < w: 
 				; Status,Z = 0. Status,C = 0.
 				; wnew = Y-w + 0x100.
	BTFSC	STATUS,C
	GOTO	y_Achse_GROESSER_170
	BTFSC	STATUS,Z
	GOTO	y_Achse_GROESSER_170

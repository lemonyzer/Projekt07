...
; **************************************************************
;
; UP_wait250khz hinzugefügt
; UP_wait05s hinzugefügt
;
; main neu aufgebaut um Programmablauf per LED's anzeigen zu lassen
;
;
;***************************************************************************
...
main	
	CALL	UP_wait05s
	BSF	a_att			;Controller ignoriert alle Daten
	...
	BSF	d1;;;;;;;;;
	CALL	UP_wait05s
	CALL	UP_linke_btns		;H'00'
	BCF	d1;;;;;;;;;
	
	BSF	a2;;;;;;;;;
	CALL	UP_wait05s
	CALL	UP_rechte_btns		;H'00'
	BCF	a2;;;;;;;;;
...
UP_Start	
	...
	;CALL UP_wait250khz	
	;BTFSC	e_data		; e_data in Register speichern	

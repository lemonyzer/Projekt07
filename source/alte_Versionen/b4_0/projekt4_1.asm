; **********************************************************
; * projekt_beta_4_1.asm - Playstation Controller an PIC16F84A *
; **********************************************************
;
...
;		LED's an sind, wo auch die zugehörigen
...
;	BSF	a1;;;;;;;;;	;--------------------------------------------DEBUGGING
	...
	GOTO	nicht_verbunden	;<- Controller nicht bereit...
				;<- Controller bereit...
	MOVLW	D'1'
...
ORG	0x300		; Tabelle in Speicherblock 3
	...
	RETLW	m_display_r	; Joystick rechts, x-Achse

	RETLW	m_RJoyY_adr	; Joystick rechts, y-Achse - Digit-Adresse
	RETLW	m_display_l	; Joystick rechts, y-Achse

	RETLW	m_LJoyX_adr	; Joystick links, x-Achse - Digit-Adresse
	RETLW	m_display_c	; Joystick links, x-Achse

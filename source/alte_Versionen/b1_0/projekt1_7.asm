...
MAX_s2	BCF	a_MAX_CLOCK	;
	...
	GOTO	MAX_s1
		        	  	;Schleifen ende
	;BSF	a_MAX_LOAD	;NACH der Übertragung von 2 Bytes auf LOW
	GOTO	MAX_s_byte2	;Nächstes Byte übertragen
...
MAX_s3	RLF	sMAX_B2		;MSB zuerst...
	BTFSC	STATUS,C
	GOTO	MAX_byte2_send_1	;Übertrage 1
	BCF	a_MAX_DATA	;Übertrage 0	
	
MAX_s4	BCF	a_MAX_CLOCK	;
	BSF	a_MAX_CLOCK	;Positive Flanke erzeugen
	BCF	a_MAX_CLOCK

...
;
;tab_MAX				; MAXIMAL bis 9 zaehlen!!!!
;	ADDWF	PCL,F		; Springe in nächste Tabellenzeile

;	RETLW	B'00000001'	; Start-Befehl
;	RETLW	B'00001100'	; Startbefehlsadresse

;	RETLW	B'00000000'	; Modus-Befehl
;	RETLW	B'00001001'	; Modusbefehlsadresse
...
UP_MAX
	...
	CALL	UP_MAX_send	;sende 1. 8 Bits
	;-
	MOVFW	gLJoyX_adress	;lade und ...
	CALL	UP_MAX_send	;sende 2. 8 Bits (Auswahl des Anzeige-Digits)
	
	MOVFW	gLJoyY		;lade und ...
	CALL	UP_MAX_send	;sende 1. 8 Bits
	;-
	MOVFW	gLJoyY_adress	;lade und ...
	CALL	UP_MAX_send	;sende 2. 8 Bits (Auswahl des Anzeige-Digits)
